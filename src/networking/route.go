...
var APIRouteList = []map[string]map[string]interface{}{
	...
	// store categories
	map[string]map[string]interface{}{
		"/store/categories/retrieve/t1": {
			"control_method": "GET",
			"authenticate":   []string{},
			"max_rps":        nil,
			"api_method":     api.RetrieveTier1StoreCategories,
			"desctiption":    []string{},
		},
	},
	map[string]map[string]interface{}{
		"/store/categories/retrieve/t2": {
			"control_method": "GET",
			"authenticate":   []string{},
			"max_rps":        nil,
			"api_method":     api.RetrieveTier2StoreCategories,
			"desctiption":    []string{},
		},
	},
	map[string]map[string]interface{}{
		"/store/categories/from_template/add": {
			"control_method": "POST",
			"authenticate":   []string{
			// models.ACCESSROLE_CONFIRMED_USER,
			// models.ACCESSROLE_STOREOWNER,
			},
			"post_payload": models.StoreCategoryIds{},
			"max_rps":      nil,
			"api_method":   api.AddStoreCategories,
			"description":  []string{},
		},
	},
	...
	/*
		map[string]map[string]interface{}{
			"/template/categories/add": {
				...
				"max_rps":      nil,
				"api_method":   api.AddStoreTemplateCategories,
				"description":  []string{},
			},
		},
	*/
	map[string]map[string]interface{}{
		"/template/categories/t1": {
			"control_method": "GET",
			"authenticate":   []string{},
			"post_payload":   nil,
			"max_rps":        nil,
			"api_method":     api.RetrieveTier1StoreTemplateCategories,
			"description": []string{
				"this will retieve all t1 categories with the order of the subcategories",
				"in the form of the children field containing a list of all the respective",
				"t2 ctegories represented by their ids. this will allow us to easily change",
				"ordering with single doc updates as well as add additional tiers as needed",
				"with minimal to no change to structures",
			},
		},
	},
	map[string]map[string]interface{}{
		"/template/categories/t2": {
			"control_method": "GET",
			"authenticate":   []string{},
			"post_payload":   nil,
			"max_rps":        nil,
			"api_method":     api.RetrieveTier2StoreTemplateCategories,
			"description": []string{
				"this will look for any categories that have a parent set to that of the",
				"category_id query param in the request url (you may use and c_id from t1",
				"categories in the above call)",
			},
		},
	},
	map[string]map[string]interface{}{
		"/template/category/t2/products": {
			"control_method": "GET",
			"authenticate":   []string{},
			"post_payload":   nil,
			"max_rps":        nil,
			"api_method":     api.RetrieveTemplateAssets,
			"description": []string{
				"grab all template products availible for the category specified by the",
				"query param category_id for the page specified by the query param p",
				"",
				"example req: ",
				"  https://mcs.store/api/template/category/t2/products?category_id=id&p=1",
			},
		},
	},
	map[string]map[string]interface{}{
		"/template/product/retrieve": {
			"control_method": "GET",
			"authenticate":   []string{},
			"post_payload":   nil,
			"max_rps":        nil,
			"api_method":     api.RetrieveTemplateAsset,
			"description": []string{
	...
	map[string]map[string]interface{}{
		"/store/products/create": {
			...
			"post_payload": []models.NewProduct{},
			"max_rps":      nil,
			"api_method":   api.AddStoreProducts,
			"description":  []string{},
		},
	},
	map[string]map[string]interface{}{
	...
	map[string]map[string]interface{}{
		"/store/category/products/retrieve": {
			"control_method": "GET",
			"authenticate":   []string{
			// models.ACCESSROLE_CONFIRMED_USER,
			// models.ACCESSROLE_STOREOWNER,
			...
			"post_payload": nil,
			"max_rps":      nil,
			"api_method":   api.RetrieveStoreCategoryProducts,
			"description":  []string{},
		},
	},
	...
	map[string]map[string]interface{}{
		"/store/cart/retrieve/:cart_id": {
			...
			"max_rps":    nil,
			"api_method": api.RetrieveStoreCartByID,
			"description": []string{
				"Call to grab a cart by id for a given store.",
			},
		},
	},
	...
	map[string]map[string]interface{}{
		"/send_email": {
			"control_method": "POST",
			"post_payload":   models.EmailReq{},
			"authenticate":   []string{},
			"max_rps":        nil,
			"api_method":     api.SendEmail,
			"description":    []string{},
		},
	},
